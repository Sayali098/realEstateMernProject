...
const About = () => {
  ...
  return (
    ...
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700'>Sahand Estate is a leading real 
        ...
        properties in the most desirable neighborhoods. Our team of experienced
         ...
         buying and selling process as smooth as possible.</p>
      ...
      <p className='mb-4 text-slate-700'>Our team of agents has a wealth of 
        experience and knowledge in the real estate industry, and we are
         committed to providing the highest level of service to our clients. 
